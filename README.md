...
Также необходимо иметь интерпретатор [Ruby](https://www.ruby-lang.org/ru/) и установленный gem [bundler](https://bundler.io/).
...
Для запуска виртуальной машины, находясь в рабочей папке проекта, введите команду `vagrant up`. После окончания настройки, для входа на сервер, используется команда `vagrant ssh`.
